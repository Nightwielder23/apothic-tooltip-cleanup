...
// blanks on other tooltips such as attribute blocks are left alone.
public final class GemBlankLineCleaner {
    ...
    public static void apply(List<Component> tooltip) {
        ...
        // Drop every blank line but keep the gem name at index 0 even if it somehow renders blank.
