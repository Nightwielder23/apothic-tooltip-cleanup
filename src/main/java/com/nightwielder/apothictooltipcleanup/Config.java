...
public class Config {
    ...
    static {
        ...
        HIDDEN_AFFIX_IDS = builder.defineListAllowEmpty(Collections.singletonList("hidden_affix_ids"), Collections::emptyList, o -> o instanceof String);
        ...
        HIDDEN_GEM_CATEGORIES = builder.defineListAllowEmpty(Collections.singletonList("hidden_gem_categories"), Collections::emptyList, o -> o instanceof String);
